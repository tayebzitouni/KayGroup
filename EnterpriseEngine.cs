...
public sealed class EnterpriseDashboardMetrics { public decimal RevenueMad { get; set; } public decimal ExpensesMad { get; set; } public decimal MarginMad { get; set; } public decimal CashBalanceMad { get; set; } public decimal ReceivablesMad { get; set; } public decimal PayablesMad { get; set; } public decimal VatPayableMad { get; set; } public decimal OverdueMad { get; set; } public int OpenOperations { get; set; } public int UnreconciledBankItems { get; set; } }
